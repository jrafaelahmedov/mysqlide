...
public class PanelQuery extends javax.swing.JPanel {
    ...
    public PanelQuery(NConnection connection, DatabaseName database) throws ClassNotFoundException, SQLException {
        initComponents();
...
//    }
    ...
    private javax.swing.JComboBox<DatabaseName> cbDatabases;
